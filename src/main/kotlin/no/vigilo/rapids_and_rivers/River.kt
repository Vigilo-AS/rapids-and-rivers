...
import no.vigilo.rapids_and_rivers.River.PacketListener.Companion.Name
...
class River(
    ...
    private val randomIdGenerator: RandomIdGenerator = RandomIdGenerator.Default
    ...
    private fun notifyPacketListener(
